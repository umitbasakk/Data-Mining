...
class AppStateNotifier extends ChangeNotifier {
  ...
  void stopShowingSplashImage() {
    ...
    service.checkAuthentication(instance);
  }

  void RouteInitializeScreen(bool value){
    LoadScreen = value;
  }
}
      ...
      routes: [
        FFRoute(
          ...
          builder: (context, _) => appStateNotifier.showSplashImage
              ...
              : appStateNotifier.LoadScreen ? const NavBarPage(initialPage: 'Home')  :const OnboardingWidget(),
        ),
        FFRoute(
          name: 'Onboarding',
          path: '/onboarding',
       ...
       FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'MyOrder')
              : const LastSearchesWidget(),
        ),
        FFRoute(
          name: 'LoginAccount',
          path: '/loginAccount',
