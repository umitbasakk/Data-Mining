  ...
  Widget build(BuildContext context) {
        ...
        if(!InitializeValue){
            WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
                  _model.userNameTextFieldTextController?.text =  userViewModel.user?.username ?? "";
                  _model.emailTextFieldTextController?.text =  userViewModel.user?.email ?? "";
                  _model.phoneTextFieldTextController?.text = userViewModel.user?.phone ?? "";
                  _model.nameTextFieldTextController?.text = userViewModel.user?.name ?? "";
            }));
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    decoration: InputDecoration(
                                                      ...
                                                      hintText:"Enter your name" /* Create your username */,
                                  ...
                                  Expanded(
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if(_model.nameTextFieldTextController.text.isEmpty){
                                        ...
                                        }else if (_model.emailTextFieldTextController.text.isEmpty){
                                          Utils.flushBarErrorMessage("Email cannot be empty ", context);
                                        }else{
                                           bool update = await authViewModel.updateProfileApi(data,context,userViewModel.user?.token??"");
                                           bool logout = await userService.Logout();
