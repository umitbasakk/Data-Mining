...
class _LoginAccountWidgetState extends State<LoginAccountWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.usernameTextFieldTextController?.text ="umitbasaak";
          _model.passwordTextFieldTextController?.text = "135980Aa";
        }));
  }
                                  ...
                                  children: [
                                    Expanded(
                                      child: FFButtonWidget(
                                        onPressed: ()  {
                                          if(_model.usernameTextFieldTextController.text.isEmpty){
