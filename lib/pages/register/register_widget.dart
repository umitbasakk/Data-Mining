...
class _RegisterWidgetState extends State<RegisterWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFF192324),
        body: SafeArea(
          top: true,
          child: Container(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Flexible(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '6cx5py4h' /* Please login with registered a... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
                                              ...
                                              Expanded(
                                                child: Container(
                                                  ...
                                                  child:  IntlPhoneField(
                                                    ...
                                                    onChanged: (phone) {
                                                      _model.phoneTextFieldTextController.text = phone.number;
                                                      _completePhone = phone.completeNumber;
                                                      print(_completePhone);
                                                    },
                                    ...
                                    Expanded(
                                      child: FFButtonWidget(
                                        onPressed: ()  {
                                         ...
                                         }else if(_model.nameTextFieldTextController.text.isEmpty){
                                              Utils.flushBarErrorMessage("Name cannot be empty ", context);
                                         }else if(_model.usernameTextFieldTextController.text.isEmpty){
                                              Utils.flushBarErrorMessage("Username cannot be empty ", context);
                                         }else if(_model.passwordTextFieldTextController.text.isEmpty){
                                              Utils.flushBarErrorMessage("Password cannot be empty ", context);
                                         }else if(_model.phoneTextFieldTextController.text.isEmpty){
                                              Utils.flushBarErrorMessage("Phone cannot be empty ", context);
                                         }else{
                                            Map data = {
                                                'name':_model.nameTextFieldTextController.text,
                                                'username':_model.usernameTextFieldTextController.text,
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Flexible(
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'u2nj6oz7' /* Do you have an acccount */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
